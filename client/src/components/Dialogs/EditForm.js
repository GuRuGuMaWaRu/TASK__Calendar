  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <DialogActions>
          <Button onClick={() => handleClose("cancel")} color="default">
            Cancel
          </Button>
          <Button onClick={() => handleClose("delete")} color="default">
            Delete
          </Button>
...
export default connect(null, actions)(withStyles(styles)(EditForm));
